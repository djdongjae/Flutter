...
import 'package:listview_example_3rd/sub/firstPage.dart';
import 'package:listview_example_3rd/sub/secondPage.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'list view home'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    al.add(Animal(an:"오동재", k:"포유류", ip:"repo/images/cow.png"));
    al.add(Animal(an:"개", k:"포유류", ip:"repo/images/dog.png"));
